...
syms TH1 TH2 TH3 TH4  TH1dt TH2dt TH3dt TH4dt TH1ddt TH2ddt TH3ddt TH4ddt
...
MM=subs(M,{d,th2,th3,th4},{TH1,TH2,TH3,TH4});
VV=subs(V,{d,th2,th3,th4,diff(d(t),t),diff(th2(t),t),diff(th3(t),t),diff(th4(t),t)},{TH1,TH2,TH3,TH4,TH1dt TH2dt,TH3dt,TH4dt});
qd=[TH1dt;TH2dt;TH3dt;TH4dt];
Vm=VV/qd;
GG=subs(G,{d,th2,th3,th4},{TH1,TH2,TH3,TH4});
T=MM*[TH1ddt;TH2ddt;TH3ddt;TH4ddt]+VV+GG;
tau1=simplify(T(1));tau2=simplify(T(2));tau3=simplify(T(3));tau4=simplify(T(4));

[cm1, ms1] = coeffs(tau1, [m1,m2,m3,m4,I1,I2,I3,I4]);
[cm2, ms2] = coeffs(tau2, [m1,m2,m3,m4,I1,I2,I3,I4]);
[cm3, ms3] = coeffs(tau3, [m1,m2,m3,m4,I1,I2,I3,I4]);
[cm4, ms4] = coeffs(tau4, [m1,m2,m3,m4,I1,I2,I3,I4]);

Phi=[m1;m2;m3;m4;I1;I2;I3;I4];
W=[cm1 0;0 cm2;0 0 cm3;0 0 0 cm4];
